import { type Control, type UseFormSetValue, type ErrorOption, type UseFormRegister, type FieldErrors } from "react-hook-form";
import { Obj } from "./app";
...
export interface RequiredFieldArray<T extends Obj> extends RequiredField<T>, FieldArray<T> {
    setError: (name: keyof T, error: ErrorOption, options?: {
        shouldFocus: boolean;
    }) => void;
